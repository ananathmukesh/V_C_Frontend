...
const Options = ({ children,callingid,callingname }) => {
        ...
        <form className={classes.root} noValidate autoComplete="off">
          <Grid container className={classes.gridContainer}>
            <Grid item xs={12} md={6} className={classes.padding}>
              ...
              <TextField variant="standard" label="name" value={callingname} onChange={e => setName(e.target.value)} fullWidth />
            ...
            <Grid item xs={12} md={6} className={classes.padding}>
              ...
              <TextField variant="standard" label="ID To Call" value={callingid} onChange={e => setIdToCall(e.target.value)} fullWidth />
              {
